...
tableextension 50610 DefaultDimensionsTableExt extends "Default Dimension"
{
    fields
    {
        modify("Dimension Code")
        {
            ...
            begin
                SetCostObjectValuesFromManufacturer(Rec);
            end;
        }
    }
    local procedure SetCostObjectValuesFromManufacturer(var Rec: Record "Default Dimension")
    var
